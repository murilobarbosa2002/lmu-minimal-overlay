...
class EditState (IApplicationState ):
    def __init__ (self ,context ,widgets :list [Widget ]):
        ...
        self._padding_base = (theme.get("padding_min", 8) + theme.get("padding_max", 12)) / 2
        self._padding_oscillation = (theme.get("padding_max", 12) - theme.get("padding_min", 8)) / 2
    ...
    def draw (self ,surface :pygame .Surface )->None :
        ...
        if self .selected_widget :
            import math
            padding_oscillation = self._padding_oscillation * math.sin(self._time_accumulator * 4) 
            ...
            pygame .draw .rect (surface ,self._selection_color ,selection_rect ,self._selection_border_width ,border_radius =self._selection_border_radius )
