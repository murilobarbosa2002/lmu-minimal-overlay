...
O `InputCard` é o componente principal de interface do LMU Telemetry Overlay. Ele integra múltiplos indicadores em um único card compacto e eficiente.
...
5.  **CardBackground**: Fundo, borda e máscara (Camada inferior)
